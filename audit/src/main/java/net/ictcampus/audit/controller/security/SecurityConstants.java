package net.ictcampus.audit.controller.security;
...
public class SecurityConstants {
    ...
    //Wir haben alle URLs gesperrt ausser die Registrierungsseite. Swagger erstellt uns aber Dokumentations URLs.
